---
title: '#DevOpsTraineeProgram - DevOps - The real stories - Day 6'
published: false
description: DevOpsTraineeProgram - DevOps - The real stories
...
I wanted to take this section to look at succesful companies that have adopted a DevOps practice and share some resources around this.
...
### Recap of our first week looking at DevOps
...
See you on [Next Section](../../README.md). 

Next we will dive into a programming language. We are not aiming to be a web developer per say but we want to be able to understand what the developers are doing.  
